package com.dio.santander.bankline.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.dio.santander.bankline.R
import com.dio.santander.bankline.databinding.BankStatementItemBinding
...
class BankStatementAdapter(private val dataSet: List<Movimentacao>) :
    ...
    class ViewHolder(private val binding: BankStatementItemBinding) :
        ...
        fun bind(item: Movimentacao) = with(binding) {
            ...
            tvDatetime.text = item.valor.toString()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = BankStatementItemBinding.inflate(LayoutInflater.from(parent.context),
            parent, false)
